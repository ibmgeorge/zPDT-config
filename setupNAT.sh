...
echo "Adding external:8023  --> z/OS TCP/IP 3270		: 10.1.1.2:23 "
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 8023 -j DNAT --to-destination 10.1.1.2:23 
echo "Adding external:1022  --> z/OS OMVS SSH			: 10.1.1.2:22 "
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 1022 -j DNAT --to-destination 10.1.1.2:22
echo "Adding external:4414  --> z/OS Broker WebUI		: 10.1.1.2:4414 "
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 4414 -j DNAT --to-destination 10.1.1.2:4414
echo "Adding external:1416  --> z/OS MQ Channel Listener	: 10.1.1.2:1416 "
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 1416 -j DNAT --to-destination 10.1.1.2:1416
echo "Adding external:1490  --> CICSTS53 CMCI			: 10.1.1.2:1490 "
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 1490 -j DNAT --to-destination 10.1.1.2:1490
echo "Adding external:4035+ --> z/OS IBM Explorer		: 10.1.1.2:4035,6715,18108-18109"
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp -m multiport --dports 4035,6715,18108:18109 -j DNAT --to-destination 10.1.1.2
echo "Adding external:8021  --> z/OS FTP			: 10.1.1.2:21 (FTP PASV PORTRANGE: 50000:50009) "
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 8021 -j DNAT --to-destination 10.1.1.2:21
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 50000:50009 -j DNAT --to-destination 10.1.1.2
echo "Adding external:9445  --> z/OS Connect EE JWT		: 10.1.1.2:8445 (NONSHAREDPORT)"
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 9445 -j DNAT --to-destination 10.1.1.2:8445
echo "Adding external:9444  --> z/OS Connect EE CLIENT AUTH	: 10.1.1.2:8444 (NONSHAREDPORT)"
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 9444 -j DNAT --to-destination 10.1.1.2:8444
echo "Adding external:9443  --> z/OS Connect EE HTTPS		: 10.1.1.2:8443 (SHAREDPORT)"
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 9443 -j DNAT --to-destination 10.1.1.2:8443
echo "Adding external:10443 --> z/OS Management Facility	: 10.1.1.2:10443"
iptables -t nat -A PREROUTING -i $EXTERNAL_INTERFACE -p tcp --dport 10443 -j DNAT --to-destination 10.1.1.2:10443
echo "------------------------------------------------------------------------------------------------------"
